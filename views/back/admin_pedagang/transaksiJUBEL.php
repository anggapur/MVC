...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Transaksi</a> <a href="#" class="current">Transaksi</a> </div>
  <h1>Transaksi</h1>
</div>
