...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Laporan</a></h1>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Laporan</a>
  <ul>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li> <a href="verifikasi_user.php"><i class="icon icon-th"></i> <span>Verifikasi User</span></a> </li>
    <li class="active"> <a href="Laporan.php"><i class="icon icon-book"></i> <span>Laporan</span></a> </li>
