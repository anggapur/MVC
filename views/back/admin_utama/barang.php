...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Barang</a></h1>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Barang</a>
  <ul>
    ...
    <li class="active"> <a href="barang.php"><i class="icon icon-tags"></i> <span>Barang</span></a> </li>
